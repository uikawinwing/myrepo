...
assert.match(fragments.homeLayoutRenderScript, /id=\"sidebarUploadBtn\"/);
assert.match(fragments.homeLayoutRenderScript, /我的项目快捷操作/);
assert.match(homeAppSource, /querySelectorAll\('\[data-return-all-projects\]'\)/);
assert.match(homeAppSource, /sidebarUploadBtn\.onclick = openUploadProject/);
