...
assert.match(fragments.homeLayoutRenderScript, /mobileOfficialTagFilter/);
assert.match(fragments.homeLayoutRenderScript, /officialTagSearchMobile/);
assert.match(fragments.homeLayoutRenderScript, /data-official-tag/);
